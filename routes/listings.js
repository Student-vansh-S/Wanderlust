...
router.get("/filter/:category",isLoggedIn,wrapAsync(listingController.category));

router.get("/category/searchbar",isLoggedIn,wrapAsync(listingController.searchBar));
